...
const bpmnTest = '<?xml version="1.0" encoding="UTF-8"?>\n' +
    '<bpmn2:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:activiti="http://activiti.org/bpmn" id="sample-diagram" targetNamespace="http://activiti.org/bpmn" xsi:schemaLocation="http://www.omg.org/spec/BPMN/20100524/MODEL BPMN20.xsd"><bpmn2:process id="Process_1" isExecutable="true"><bpmn2:extensionElements><activiti:variable id="BOM01" name="varTest01" type="int" isVisible="false" isNecessary="false" isReadOnly="false" isReset="false" /><activiti:variable id="BOM11" name="varTest02" type="boolean" isVisible="false" isNecessary="false" isReadOnly="false" isReset="false" /></bpmn2:extensionElements><bpmn2:startEvent id="StartEvent_01tza0c" name="开始"><bpmn2:extensionElements /><bpmn2:outgoing>SequenceFlow_18ews7b</bpmn2:outgoing></bpmn2:startEvent><bpmn2:userTask id="UserTask_0h0jffi" name="提交"><bpmn2:extensionElements><activiti:formTemplate taskFormTemplate="Analyze Change Request" signingRequired="true" isSendNotification="true" /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:voteSelect><activiti:vote id="SequenceFlow_00yf546" name="提交" priority="1" requiredReason="false" /><activiti:vote id="SequenceFlow_1az2cr7" name="取消" priority="1" requiredReason="false" /></activiti:voteSelect><activiti:deadline deadlineDay="1" deadlineHour="1" deadlineMinute="1" overdueResult="markComplete" overdueBeforeDay="2" overdueBeforeHour="2" overdueBeforeMinute="2" overdueAfterDay="3" overdueAfterHour="3" overdueAfterMinute="3" isNotice="true"><activiti:role name="zhangsan" type="role" roleCode="审批者" id="1" /><activiti:role name="lisi" type="role" roleCode="审批者" id="2" /><activiti:role name="zhaoliu" type="role" roleCode="终结者" id="4" /><activiti:vote id="SequenceFlow_00yf546" name="提交" /></activiti:deadline><activiti:roleSet id="30" name="路易三十一" code="吃瓜群众" view="false" add="false" remove="false" sourceRef="UserTask_1n2b6td" /><activiti:roleSet id="32" name="路易三十三" code="吃瓜群众" view="false" add="false" remove="false" sourceRef="UserTask_1n2b6td" /><activiti:roleSet id="34" name="路易三十五" code="吃瓜群众" view="false" add="false" remove="false" sourceRef="UserTask_1n2b6td" /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_18ews7b</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_1az2cr7</bpmn2:outgoing><bpmn2:outgoing>SequenceFlow_00yf546</bpmn2:outgoing><bpmn2:outgoing>SequenceFlow_1r78xk3</bpmn2:outgoing></bpmn2:userTask><bpmn2:sequenceFlow id="SequenceFlow_18ews7b" sourceRef="StartEvent_01tza0c" targetRef="UserTask_0h0jffi" /><bpmn2:serviceTask id="ServiceTask_1u9qqi9" name="发送邮件" activiti:type="mail"><bpmn2:extensionElements><activiti:responsibleRole roleCode="approver" /><activiti:recipient><activiti:assign userName="san" type="user" id="1" fullName="zhangsan" /><activiti:assign userName="wu" type="user" id="3" fullName="wangwu" /><activiti:group name="2" type="group" id="3" /><activiti:group name="3" type="group" id="5" /><activiti:role name="zhangsan" type="role" roleCode="审批者" id="1" /><activiti:role name="wangwu" type="role" roleCode="终结者" id="3" /><activiti:operator name="操作者" type="Operator" id="operator_code" roleCode="operator_code" /><activiti:variable id="BOM01" name="varTest01" type="variable" /><activiti:variable id="BOM11" name="varTest02" type="variable" /><activiti:email mail="1@pisx.com" type="Email" id="1@pisx.com" /></activiti:recipient><activiti:message subject="{primaryBusinessObject}" subjectSelect="pboSubject" messageBody="sdgfdsg" /><activiti:attachment primaryContent="true" secondContent="true" attrInfo="true"><activiti:variable id="BOM01" name="varTest01" type="variable" /><activiti:variable id="BOM11" name="varTest02" type="variable" /></activiti:attachment></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_1az2cr7</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_0otvex3</bpmn2:outgoing></bpmn2:serviceTask><bpmn2:sequenceFlow id="SequenceFlow_1az2cr7" name="取消" sourceRef="UserTask_0h0jffi" targetRef="ServiceTask_1u9qqi9" /><bpmn2:serviceTask id="ServiceTask_0dbf7vd" name="CLOSE" activiti:class="com.pisx.tundra.foundation.workflow.listener.WfProcessSetStateListener"><bpmn2:extensionElements><activiti:field name="stateKey"><activiti:string>close</activiti:string></activiti:field></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_0otvex3</bpmn2:incoming><bpmn2:incoming>SequenceFlow_0ki4ie4</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_048md5n</bpmn2:outgoing></bpmn2:serviceTask><bpmn2:sequenceFlow id="SequenceFlow_0otvex3" sourceRef="ServiceTask_1u9qqi9" targetRef="ServiceTask_0dbf7vd" /><bpmn2:endEvent id="EndEvent_0s1lb7w" name="结束"><bpmn2:extensionElements /><bpmn2:incoming>SequenceFlow_048md5n</bpmn2:incoming><bpmn2:incoming>SequenceFlow_03lyf8v</bpmn2:incoming></bpmn2:endEvent><bpmn2:sequenceFlow id="SequenceFlow_048md5n" sourceRef="ServiceTask_0dbf7vd" targetRef="EndEvent_0s1lb7w" /><bpmn2:userTask id="UserTask_1n2b6td" name="审核"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="NO" number="" name="路易三十一" type="role" roleCode="吃瓜群众" id="30" /><activiti:role need="NO" number="" name="路易三十三" type="role" roleCode="吃瓜群众" id="32" /><activiti:role need="NO" number="" name="路易三十五" type="role" roleCode="吃瓜群众" id="34" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_00yf546</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_0ki4ie4</bpmn2:outgoing></bpmn2:userTask><bpmn2:sequenceFlow id="SequenceFlow_00yf546" name="提交" sourceRef="UserTask_0h0jffi" targetRef="UserTask_1n2b6td" /><bpmn2:sequenceFlow id="SequenceFlow_0ki4ie4" sourceRef="UserTask_1n2b6td" targetRef="ServiceTask_0dbf7vd" /><bpmn2:serviceTask id="ServiceTask_15wo5mi" name="子流程1" activiti:class="com.pisx.tundra.foundation.workflow.listener.StartSubProcessListener"><bpmn2:extensionElements><activiti:field name="templateName"><activiti:string>子流程1</activiti:string></activiti:field></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_1r78xk3</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_03lyf8v</bpmn2:outgoing></bpmn2:serviceTask><bpmn2:sequenceFlow id="SequenceFlow_1r78xk3" sourceRef="UserTask_0h0jffi" targetRef="ServiceTask_15wo5mi" /><bpmn2:sequenceFlow id="SequenceFlow_03lyf8v" sourceRef="ServiceTask_15wo5mi" targetRef="EndEvent_0s1lb7w" /></bpmn2:process><bpmndi:BPMNDiagram id="BPMNDiagram_1"><bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_1"><bpmndi:BPMNShape id="StartEvent_01tza0c_di" bpmnElement="StartEvent_01tza0c"><dc:Bounds x="392" y="222" width="36" height="36" /><bpmndi:BPMNLabel><dc:Bounds x="399" y="261" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNShape><bpmndi:BPMNShape id="UserTask_0h0jffi_di" bpmnElement="UserTask_0h0jffi"><dc:Bounds x="480" y="215" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_18ews7b_di" bpmnElement="SequenceFlow_18ews7b"><di:waypoint x="428" y="240" /><di:waypoint x="480" y="240" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="ServiceTask_1u9qqi9_di" bpmnElement="ServiceTask_1u9qqi9"><dc:Bounds x="595" y="215" width="50" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_1az2cr7_di" bpmnElement="SequenceFlow_1az2cr7"><di:waypoint x="543" y="240" /><di:waypoint x="595" y="240" /><bpmndi:BPMNLabel><dc:Bounds x="559" y="222" width="21" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNShape id="ServiceTask_0dbf7vd_di" bpmnElement="ServiceTask_0dbf7vd"><dc:Bounds x="735" y="215" width="50" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_0otvex3_di" bpmnElement="SequenceFlow_0otvex3"><di:waypoint x="645" y="240" /><di:waypoint x="735" y="240" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="EndEvent_0s1lb7w_di" bpmnElement="EndEvent_0s1lb7w"><dc:Bounds x="862" y="222" width="36" height="36" /><bpmndi:BPMNLabel><dc:Bounds x="869" y="261" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_048md5n_di" bpmnElement="SequenceFlow_048md5n"><di:waypoint x="785" y="240" /><di:waypoint x="862" y="240" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="UserTask_1n2b6td_di" bpmnElement="UserTask_1n2b6td"><dc:Bounds x="600" y="310" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_00yf546_di" bpmnElement="SequenceFlow_00yf546"><di:waypoint x="511" y="265" /><di:waypoint x="511" y="335" /><di:waypoint x="600" y="335" /><bpmndi:BPMNLabel><dc:Bounds x="515" y="297" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNEdge id="SequenceFlow_0ki4ie4_di" bpmnElement="SequenceFlow_0ki4ie4"><di:waypoint x="662" y="335" /><di:waypoint x="760" y="335" /><di:waypoint x="760" y="265" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="ServiceTask_15wo5mi_di" bpmnElement="ServiceTask_15wo5mi"><dc:Bounds x="595" y="115" width="50" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_1r78xk3_di" bpmnElement="SequenceFlow_1r78xk3"><di:waypoint x="511" y="215" /><di:waypoint x="511" y="140" /><di:waypoint x="595" y="140" /></bpmndi:BPMNEdge><bpmndi:BPMNEdge id="SequenceFlow_03lyf8v_di" bpmnElement="SequenceFlow_03lyf8v"><di:waypoint x="645" y="140" /><di:waypoint x="880" y="140" /><di:waypoint x="880" y="222" /></bpmndi:BPMNEdge></bpmndi:BPMNPlane></bpmndi:BPMNDiagram></bpmn2:definitions>'
