...
const bpmnTest = '<?xml version="1.0" encoding="UTF-8"?><bpmn2:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:activiti="http://activiti.org/bpmn" id="sample-diagram" targetNamespace="http://activiti.org/bpmn" xsi:schemaLocation="http://www.omg.org/spec/BPMN/20100524/MODEL BPMN20.xsd"><bpmn2:process id="Process_1" name="网关扩展" isExecutable="true"><bpmn2:extensionElements><activiti:variable id="BOM01" name="varTest01" type="int" isVisible="false" isNecessary="false" isReadOnly="false" isReset="false" /><activiti:variable id="BOM11" name="varTest02" type="boolean" isVisible="false" isNecessary="false" isReadOnly="false" isReset="false" /></bpmn2:extensionElements><bpmn2:startEvent id="StartEvent_01tza0c" name="开始"><bpmn2:extensionElements /><bpmn2:outgoing>SequenceFlow_03sf7xj</bpmn2:outgoing></bpmn2:startEvent><bpmn2:exclusiveGateway id="ExclusiveGateway_0mtkadf"><bpmn2:incoming>SequenceFlow_03sf7xj</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_19g0ebx</bpmn2:outgoing><bpmn2:outgoing>SequenceFlow_1i2o0s7</bpmn2:outgoing></bpmn2:exclusiveGateway><bpmn2:sequenceFlow id="SequenceFlow_03sf7xj" sourceRef="StartEvent_01tza0c" targetRef="ExclusiveGateway_0mtkadf" /><bpmn2:userTask id="UserTask_044dsty" name="提交"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_19g0ebx</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_0u8bmjo</bpmn2:outgoing></bpmn2:userTask><bpmn2:userTask id="UserTask_1x95sis" name="编制"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_1i2o0s7</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_1y4hjgc</bpmn2:outgoing></bpmn2:userTask><bpmn2:sequenceFlow id="SequenceFlow_19g0ebx" name="提交" sourceRef="ExclusiveGateway_0mtkadf" targetRef="UserTask_044dsty" /><bpmn2:sequenceFlow id="SequenceFlow_1i2o0s7" name="编制" sourceRef="ExclusiveGateway_0mtkadf" targetRef="UserTask_1x95sis" /><bpmn2:inclusiveGateway id="InclusiveGateway_0uwgm32"><bpmn2:extensionElements><activiti:threshold /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_0u8bmjo</bpmn2:incoming><bpmn2:incoming>SequenceFlow_1y4hjgc</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_18dq1nf</bpmn2:outgoing><bpmn2:outgoing>SequenceFlow_03oxfz0</bpmn2:outgoing></bpmn2:inclusiveGateway><bpmn2:sequenceFlow id="SequenceFlow_0u8bmjo" sourceRef="UserTask_044dsty" targetRef="InclusiveGateway_0uwgm32" /><bpmn2:sequenceFlow id="SequenceFlow_1y4hjgc" sourceRef="UserTask_1x95sis" targetRef="InclusiveGateway_0uwgm32" /><bpmn2:userTask id="UserTask_0nr67l4" name="审核"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_18dq1nf</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_0v8rqte</bpmn2:outgoing></bpmn2:userTask><bpmn2:sequenceFlow id="SequenceFlow_18dq1nf" name="审核" sourceRef="InclusiveGateway_0uwgm32" targetRef="UserTask_0nr67l4" /><bpmn2:userTask id="UserTask_1t7sxre" name="据审"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_03oxfz0</bpmn2:incoming><bpmn2:outgoing>SequenceFlow_1gs787c</bpmn2:outgoing></bpmn2:userTask><bpmn2:sequenceFlow id="SequenceFlow_03oxfz0" name="据审" sourceRef="InclusiveGateway_0uwgm32" targetRef="UserTask_1t7sxre" /><bpmn2:endEvent id="EndEvent_004qd49" name="结束"><bpmn2:extensionElements><activiti:formTemplate /><activiti:participant><activiti:role need="ALL" number="" name="操作者" type="role" roleCode="operator_code" id="operator_code" /></activiti:participant><activiti:deadline /><activiti:voteSelect /></bpmn2:extensionElements><bpmn2:incoming>SequenceFlow_0v8rqte</bpmn2:incoming><bpmn2:incoming>SequenceFlow_1gs787c</bpmn2:incoming></bpmn2:endEvent><bpmn2:sequenceFlow id="SequenceFlow_0v8rqte" sourceRef="UserTask_0nr67l4" targetRef="EndEvent_004qd49" /><bpmn2:sequenceFlow id="SequenceFlow_1gs787c" sourceRef="UserTask_1t7sxre" targetRef="EndEvent_004qd49" /></bpmn2:process><bpmndi:BPMNDiagram id="BPMNDiagram_1"><bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_1"><bpmndi:BPMNShape id="StartEvent_01tza0c_di" bpmnElement="StartEvent_01tza0c"><dc:Bounds x="272" y="272" width="36" height="36" /><bpmndi:BPMNLabel><dc:Bounds x="279" y="311" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNShape><bpmndi:BPMNShape id="ExclusiveGateway_0mtkadf_di" bpmnElement="ExclusiveGateway_0mtkadf" isMarkerVisible="true"><dc:Bounds x="405" y="265" width="50" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_03sf7xj_di" bpmnElement="SequenceFlow_03sf7xj"><di:waypoint x="308" y="290" /><di:waypoint x="405" y="290" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="UserTask_044dsty_di" bpmnElement="UserTask_044dsty"><dc:Bounds x="509" y="165" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNShape id="UserTask_1x95sis_di" bpmnElement="UserTask_1x95sis"><dc:Bounds x="509" y="365" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_19g0ebx_di" bpmnElement="SequenceFlow_19g0ebx"><di:waypoint x="430" y="265" /><di:waypoint x="430" y="190" /><di:waypoint x="509" y="190" /><bpmndi:BPMNLabel><dc:Bounds x="434" y="225" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNEdge id="SequenceFlow_1i2o0s7_di" bpmnElement="SequenceFlow_1i2o0s7"><di:waypoint x="430" y="315" /><di:waypoint x="430" y="390" /><di:waypoint x="509" y="390" /><bpmndi:BPMNLabel><dc:Bounds x="435" y="350" width="21" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNShape id="InclusiveGateway_0uwgm32_di" bpmnElement="InclusiveGateway_0uwgm32"><dc:Bounds x="635" y="285" width="50" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_0u8bmjo_di" bpmnElement="SequenceFlow_0u8bmjo"><di:waypoint x="571" y="190" /><di:waypoint x="660" y="190" /><di:waypoint x="660" y="285" /></bpmndi:BPMNEdge><bpmndi:BPMNEdge id="SequenceFlow_1y4hjgc_di" bpmnElement="SequenceFlow_1y4hjgc"><di:waypoint x="571" y="390" /><di:waypoint x="660" y="390" /><di:waypoint x="660" y="335" /></bpmndi:BPMNEdge><bpmndi:BPMNShape id="UserTask_0nr67l4_di" bpmnElement="UserTask_0nr67l4"><dc:Bounds x="769" y="165" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_18dq1nf_di" bpmnElement="SequenceFlow_18dq1nf"><di:waypoint x="672" y="298" /><di:waypoint x="772" y="211" /><bpmndi:BPMNLabel><dc:Bounds x="710" y="236" width="23" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNShape id="UserTask_1t7sxre_di" bpmnElement="UserTask_1t7sxre"><dc:Bounds x="769" y="365" width="62.5" height="50" /></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_03oxfz0_di" bpmnElement="SequenceFlow_03oxfz0"><di:waypoint x="675" y="320" /><di:waypoint x="769" y="375" /><bpmndi:BPMNLabel><dc:Bounds x="712" y="330" width="21" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNEdge><bpmndi:BPMNShape id="EndEvent_004qd49_di" bpmnElement="EndEvent_004qd49"><dc:Bounds x="922" y="282" width="36" height="36" /><bpmndi:BPMNLabel><dc:Bounds x="929" y="321" width="22" height="14" /></bpmndi:BPMNLabel></bpmndi:BPMNShape><bpmndi:BPMNEdge id="SequenceFlow_0v8rqte_di" bpmnElement="SequenceFlow_0v8rqte"><di:waypoint x="831" y="190" /><di:waypoint x="877" y="190" /><di:waypoint x="877" y="300" /><di:waypoint x="922" y="300" /></bpmndi:BPMNEdge><bpmndi:BPMNEdge id="SequenceFlow_1gs787c_di" bpmnElement="SequenceFlow_1gs787c"><di:waypoint x="831" y="390" /><di:waypoint x="877" y="390" /><di:waypoint x="877" y="300" /><di:waypoint x="922" y="300" /></bpmndi:BPMNEdge></bpmndi:BPMNPlane></bpmndi:BPMNDiagram></bpmn2:definitions>'
