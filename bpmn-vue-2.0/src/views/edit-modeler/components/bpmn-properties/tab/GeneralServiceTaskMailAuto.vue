	...
	<div class="properties">
		<a-tabs type="card" v-model="activeTab">
			<a-tab-pane key="general" :tab="local.general">
				<general-mail-auto :param="param" :general="mailGeneral" @updateMailGeneral="updateMailGeneral"/>
			</a-tab-pane>
			...
			<a-tab-pane key="attachment" :tab="local.attachment">
				<MailAttachment :attachment="mailAttachment" @updateAttachmentVar="updateAttachmentVar"
    ...
    export default {
        ...
        methods: {
            ...
            updateParticipant(type, participant, participantKey, participantData) {
                this.$emit('updateMailRecipient', type, participant, participantKey, participantData);
            },
            updateAttachmentVar(attachmentModel, attachmentData) {
                this.$emit('updateMailAttachment', attachmentModel, attachmentData);
            }
        },
    }
</script>