<template>
    ...
    <div class="participant-context">
        <a-tabs class='table-box' default-active-key="assigns" tab-position="left" @change="changeTab">
            ...
            <a-tab-pane :tab="local.operator" key='operator' class='flex'>
                <div class="context-left">
                    <div class="table-left">
                        <table>
                            <tr>
            ...
            <a-tab-pane :tab="local.team" key='team' class='flex'>
                <div class="context-left">
                    <div class="table-left">
                        <table>
                            <tr>
            ...
            <a-tab-pane :tab="local.variable" key='variable' class='flex'>
                <div class="context-left">
                    <div class="table-left">
                        <table>
                            <tr>
            ...
            <a-tab-pane :tab="local.email" key='email' class='flex'>
                <div class="context-left">
                    <div class="table-left">
                        <table>
                            <tr>
        ...
        methods: {
            ...
            optionRightList(participantData, type) {
                ...
                if ('remove' === type) {
                    ...
                    this.$emit('updateParticipant', this.participant, this.activeKey, participantData);
                } else {
                    this.$emit('updateParticipant', this.participant, this.activeKey, participantData);
                }
            },
